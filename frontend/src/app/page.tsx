            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="col-span-1 md:col-span-1 bg-surface-container-lowest rounded-xl p-8 card-hover transition-all duration-300 ambient-shadow flex flex-col justify-between min-h-[400px]">
                ...
                <div className="flex justify-center mt-8">
                  <span className={`px-4 py-2 rounded-full text-xs font-extrabold uppercase tracking-widest ${Object.values(result.scores)[0] < 50 ? 'bg-secondary/10 text-secondary' : 'bg-primary/10 text-primary'}`}>
                    {Object.values(result.scores)[0] < 50 ? 'Absolute Disaster' : 'Needs Work'}
                  </span>
                </div>
              </div>
